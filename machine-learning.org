...
** Statistics Theory
*** Hypothesis Testing
Card game exapmle: How many cards you guess right out of 10, for normal person it's 8
|--------------------------------+------------------------------------------------------------------------------------------------------------|
| Term                           | Description                                                                                                |
|--------------------------------+------------------------------------------------------------------------------------------------------------|
...
| ~p-value~                      | ~p-value(experimentValue) = prob(experimentValue is due to change)~ under assumption H0 is true.           |
